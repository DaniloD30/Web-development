...
class Usuarios(models.Model):
        ...
        idUsuario = models.IntegerField(max_length=11, primary_key = True)
...
class Empresas(models.Model):
        ...
        idEmpresas = models.IntegerField(max_length=11, primary_key = True)
...
class Clientes(models.Model):
        ...
        idClientes = models.IntegerField(max_length=11, primary_key = True)
        razaoSocial = models.CharField(max_length=50)
        identificacao = models.CharField(max_length=50)
        tipoPessoa = models.CharField(max_length=10)
...
class Fornecedores(models.Model):
        ...
        idFornecedores = models.IntegerField(max_length=11, primary_key = True)
        razaoSocial = models.CharField(max_length=50)
        identificacao = models.CharField(max_length=50)
        tipoPessoa = models.CharField(max_length=10)
        cnpjCpf = models.CharField(max_length=15)
...
class ContasBancarias(models.Model):
        ...
        idContasBancarias = models.IntegerField(max_length=11, primary_key = True)
...
class PlanodeContas(models.Model):
        ...
        idPlanodeContas = models.IntegerField(max_length=11, primary_key = True)
...
class Tesouraria(models.Model):
        ...
        idTesouraria = models.IntegerField(max_length=11, primary_key = True)
...
class LancamentoReceber(models.Model):
        ...
        idLancamentosReceber = models.IntegerField(max_length=11, primary_key = True)
...
class LancamentoPagar(models.Model):
        ...
        idLancamentosPagar = models.IntegerField(max_length=11, primary_key = True)
        idFornecedores =  models.ForeignKey(Fornecedores, on_delete=models.CASCADE, null=True)
        idEmpresas=  models.ForeignKey(Empresas, on_delete=models.SET_NULL, null=True)
        dataEmissao = models.CharField(max_length=12)
        dataVencimento = models.CharField(max_length=12)
...
class BaixaPagar(models.Model):
        ...
        idBaixasPagar = models.IntegerField(max_length=11, primary_key = True)
        idFormasPagamento =  models.ForeignKey(FormasPagamento, on_delete=models.CASCADE, null=True)
...
class BaixaReceber(models.Model):
        ...
        idBaixasReceber = models.IntegerField(max_length=11, primary_key = True)
        idFormasPagamento =  models.ForeignKey(FormasPagamento, on_delete=models.CASCADE, null=True)
